@section('javascriptLocal')
    ...
    <script src="{{ asset('Auth-Panel/plugins/datatables-buttons/js/buttons.bootstrap4.min.js') }}"></script>
   ...
   <script>
    ...
    $.ajax({
        ...
        error: function(response) {
            toastError("Houve um erro", "Usuário não encontrado. Status: " + response.status);
        }
    });
}
        ...
        function dataFormDelete(id) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    formDeleteUser.attr("action","/usuarios/remocao/"+id)
                },
                error: function(response) {
                    toastError("Houve um erro", "Usuário não encontrado. Status: " + response.status);
                },
